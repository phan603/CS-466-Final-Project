...
sequence_lengths = [100, 500, 1000, 5000, 10000, 20000]  # Sizes for testing
times = []
memory_usages = []
...
# Length vs Space
plt.figure(figsize=(10, 5))
plt.plot(sequence_lengths, memory_usages, marker='o', color='orange')
plt.title("Sequence Length vs Space Taken")
plt.xlabel("Sequence Length")
